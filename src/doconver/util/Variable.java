...
public class Variable implements Serializable {
	...
	public static final String[][] MENU_ITEMS = { MENU_WORD, MENU_EXCEL, MENU_POWER_POINT, MENU_ODT, MENU_ODS,
			MENU_ODP };
	public static final String[][] MENU_EXT = { EXT_WORD, EXT_EXCEL, EXT_POWER_POINT, EXT_ODT, EXT_ODS, EXT_ODP };
	public static final String[][] MENU_EXT_CONVERT = { 
			{ EXT_ODT[0], EXT_PDF[0] }, 
			{ EXT_ODS[0], EXT_PDF[0] },
			{ EXT_ODP[0], EXT_PDF[0] }, 
			{ EXT_WORD[0], EXT_PDF[0] }, 
			{ EXT_EXCEL[0], EXT_PDF[0] },
			{ EXT_POWER_POINT[0], EXT_PDF[0] } 
	};
